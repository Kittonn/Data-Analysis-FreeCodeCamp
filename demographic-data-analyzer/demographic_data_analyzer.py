...
def calculate_demographic_data(print_data=True):
    ...
    higher_education = df[df['education'].isin(options)]
    ...
    earn_50K = df[df['salary'] == '>50K']
    top_IN_occupation = earn_50K[earn_50K['native-country'] == 'India']['occupation'].value_counts().index[0]
